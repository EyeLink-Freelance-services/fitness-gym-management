  ...
  public: {
    Tables: {
      client_data_schema_fields: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_data_schema_fields_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "client_data_schema_fields_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "client_data_schema_groups"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "fk_schema_fields_group_company"
      ...
      client_data_schema_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_data_schema_groups_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      client_data_schema_validation_rules: {
        Row: {
          archived: boolean
          company_id: string
          created_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "client_data_schema_validation_rules_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      coach_formulas_overrides: {
        ...
        Relationships: [
          {
            foreignKeyName: "coach_formulas_overrides_company_formula_id_fkey"
            columns: ["company_formula_id"]
            isOneToOne: false
          ...
          },
          {
            ...
            columns: ["company_formula_id"]
            isOneToOne: false
            referencedRelation: "v_effective_client_data_schema_formulas"
            referencedColumns: ["base_formula_id"]
          },
          {
            foreignKeyName: "coach_formulas_overrides_company_formula_id_fkey"
            columns: ["company_formula_id"]
          ...
          {
            foreignKeyName: "coach_formulas_overrides_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      coach_schema_field_overrides: {
        ...
        Relationships: [
          {
            foreignKeyName: "coach_schema_field_overrides_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "coach_schema_field_overrides_field_id_fkey"
            columns: ["field_id"]
            isOneToOne: false
            referencedRelation: "client_data_schema_fields"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "coach_schema_field_overrides_group_override_id_fkey"
            columns: ["group_override_id"]
            isOneToOne: false
            referencedRelation: "coach_schema_group_overrides"
            referencedColumns: ["id"]
          },
        ]
      }
      coach_schema_group_overrides: {
        Row: {
          accent_color: string | null
          archived: boolean | null
          coach_user_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "coach_schema_group_overrides_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "coach_schema_group_overrides_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "client_data_schema_groups"
            referencedColumns: ["id"]
      ...
      coach_schema_validation_rule_overrides: {
        Row: {
          archived: boolean | null
          coach_user_id: string
          company_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "coach_schema_validation_rule_overrides_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "coach_schema_validation_rule_overrides_validation_rule_id_fkey"
            columns: ["validation_rule_id"]
            isOneToOne: false
            referencedRelation: "client_data_schema_validation_rules"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      company_coach_details: {
        ...
        Relationships: [
          {
            foreignKeyName: "company_coach_details_company_user_id_fkey"
          ...
          {
            foreignKeyName: "company_coach_details_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "company_coach_details_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      member_dynamic_field_values: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_member_dynamic_values_field_company"
            columns: ["field_id", "company_id"]
            isOneToOne: false
            referencedRelation: "client_data_schema_fields"
            referencedColumns: ["id", "company_id"]
          },
          {
            foreignKeyName: "fk_member_dynamic_values_member_company"
          ...
          {
            foreignKeyName: "member_dynamic_field_values_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "member_dynamic_field_values_field_id_fkey"
            columns: ["field_id"]
            isOneToOne: false
            referencedRelation: "client_data_schema_fields"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "member_dynamic_field_values_member_id_fkey"
            columns: ["member_id"]
            isOneToOne: false
            referencedRelation: "members"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      v_effective_client_data_schema_formulas: {
        Row: {
          base_formula_id: string | null
          coach_formula_override_id: string | null
    ...
    Functions: {
      ...
      create_company_coach:
        | {
            Args: {
              ...
              p_status?: Database["public"]["Enums"]["coach_status"]
              p_user_id: string
              p_year_exp?: number
            }
            Returns: Json
      ...
      get_effective_schema_fields: {
        Args: { p_company_id: string }
        Returns: {
          archived: boolean
          base_field_id: string
          coach_field_override_id: string
          company_id: string
          created_at: string
          description: string
          group_id: string
      ...
      get_effective_schema_formulas: {
        ...
        Returns: {
          ...
          coach_formula_override_id: string
          company_id: string
          created_at: string
          decimals: number
          description: string
      ...
      get_effective_schema_groups: {
        Args: { p_company_id: string }
        Returns: {
          accent_color: string
          archived: boolean
          base_group_id: string
          coach_group_override_id: string
          company_id: string
          created_at: string
          description: string
          icon_key: string
      ...
      get_effective_schema_validation_rules: {
        ...
        Returns: {
          archived: boolean
          base_validation_rule_id: string
          coach_validation_rule_override_id: string
          company_id: string
          created_at: string
          description: string
          id: string
      ...
      save_coach_formula_override_bundle: {
        Args: { p_payload: Json }
        Returns: Json
      }
      save_coach_schema_override_bundle: {
        Args: { p_payload: Json }
        Returns: Json
      }
      save_company_formula_bundle: { Args: { p_payload: Json }; Returns: Json }
      save_company_schema_bundle: { Args: { p_payload: Json }; Returns: Json }
      save_company_schema_tree: { Args: { p_payload: Json }; Returns: Json }
      seed_default_company_role_permissions:
        | { Args: { p_company_id: string }; Returns: undefined }
        | { Args: { p_company_id: string; p_mode: string }; Returns: undefined }
